...
//     // res.send('Hello!'); this will display the word hello on the browser: http://localhost:3001/api/animals
//     res.json(animals); // this displays the animal json on the browser
//   });
//we are using the send() method from the res parameter (short for response) 
...
app.get('/api/animals', (req, res) => {
    let results = animals;
    // call filterbyquery in the app.get call back to return the new filtered array
    if (req.query) {
